...
/**
 * This is the model class for table "club_registration".
 *
 * The followings are the available columns in table 'club_registration':
 * @property integer $id
 ...
 * @property Tie[] $ties1
 */
class ClubRegistration extends ActiveRecord
{
	/**
	 ...
	 * @return ClubRegistration the static model class
	 */
